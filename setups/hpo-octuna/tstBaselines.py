...
# Quick test run (2 trials) 
    python tstBaselines.py --crop wheat --country NL --model_type informer --n_trials 4 --epochs 2 --results_dir checkpoints-test/results --forecast_type middle-of-season --aggregation daily --use_exponential_weighting --exponential_tau 3 --multi_year_summaries --multi_year_window 1 --multi_year_features all
...
if __name__ == "__main__":
    ...
    print(f"  DataFraction={data_fraction}  SOTA={args.use_sota_features}  "
          f"Spatial={args.include_spatial_features}  Lag={args.lag_years}")
